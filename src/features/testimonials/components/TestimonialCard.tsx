...
export function TestimonialCard({ testimonial, onPlayVideo }: TestimonialCardProps) {
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl">
      <button 
        className="relative aspect-video w-full focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
